...
class LikeActivity : AppCompatActivity(), CardStackListener {
    ...
    private fun initMatchedListButton() {
        val matchedListButon = findViewById<Button>(R.id.matchListButton)
        matchedListButon.setOnClickListener {
    ...
    private fun like() {
        ...
        userDB.child(card.userId)
            ...
            .setValue(true)
        saveMatchOtherUserLikedMe(card.userId)
        // 매칭이 된 시점을 봐야한다
    ...
    private fun saveMatchOtherUserLikedMe(otherUserId: String) {
