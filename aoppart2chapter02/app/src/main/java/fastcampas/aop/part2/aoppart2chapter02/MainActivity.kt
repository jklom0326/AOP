package fastcampas.aop.part2.aoppart2chapter02
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initAddButton() {
        addButton.setOnClickListener {
            ...
            if (didRun) {
                ...
                // 리턴을할때 클릭리스너 펑션만 리턴하기위해 @setOnClickListener를 붙인다
            }
    ...
    private fun setNumberBackground(number: Int, textView: TextView) {
        when (number) {
            ...
            else -> textView.background = ContextCompat.getDrawable(this, R.drawable.circle_greeen)
        }
    }
