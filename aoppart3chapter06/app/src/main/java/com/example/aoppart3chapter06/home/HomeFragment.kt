...
import com.example.aoppart3chapter06.DBKey.Companion.DB_ARTICLES
import com.example.aoppart3chapter06.DBKey.Companion.DB_USERS
import com.example.aoppart3chapter06.R
import com.example.aoppart3chapter06.chatlist.ChatListItem
        ...
        articleAdapter = ArticleAdapter(onItemClicked = { articleModel ->
            if (auth.currentUser != null) {
                if (auth.currentUser!!.uid != articleModel.sellerId) {
                    ...
                    Snackbar.make(view, "채팅방이 생성되었습니다. 채팅탭에서 확인해주세요요",Snackbar.LENGTH_LONG).show()
                } else {
